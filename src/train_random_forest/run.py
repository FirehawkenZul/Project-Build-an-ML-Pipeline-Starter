...
def go(args):
    ...
    # signature = mlflow.models.infer_signature(X_val, y_pred) Note bug: https://knowledge.udacity.com/questions/1061602 
    mlflow.sklearn.save_model(
        sk_pipe,
        path = "random_forest_dir",
        # signature = signature, Note bug: https://knowledge.udacity.com/questions/1061602
